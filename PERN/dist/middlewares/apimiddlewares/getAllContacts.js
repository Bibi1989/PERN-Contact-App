...
exports.getAContact = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const contact = yield pg_connect_1.db.query(pg_connect_1.sql `SELECT * FROM contacts WHERE user_id = ${req.user.id} AND id =${id}`);
...
exports.deleteContact = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        yield pg_connect_1.db.query(pg_connect_1.sql `DELETE FROM contacts WHERE id = ${id} AND user_id = ${req.user.id}`);
